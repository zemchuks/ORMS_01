    ...
    <section class="bg-white">
      <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
        <form class="w-full max-w-md">
          {/* <img class="w-auto h-15 sm:h-8" src="https://merakiui.com/images/logo.svg" alt="" /> */}
          ...
          <div class="mt-6">
            <button onClick={() => navigate('/dashboard')} class="w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-lg hover:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-50">
              Sign in
            </button>
            ...
            <div class="mt-6 text-center ">
              <Link to='/signup' href="#" class="text-sm text-blue-500 hover:underline dark:text-blue-400">
