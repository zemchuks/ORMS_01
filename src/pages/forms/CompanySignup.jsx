    ...
    return (
        <section className="bg-white ">
            <div className="flex justify-center min-h-screen">
                <div className="hidden bg-cover bg-gray-400 lg:block lg:w-2/5" >
                </div>

                <div className="flex items-center w-full max-w-3xl p-8 mx-auto lg:px-12 lg:w-3/5">
                    <div className="w-full">
                        <h1 className="text-2xl mt-20 font-semibold tracking-wider text-gray-800 capitalize">
                        ...
                        <form className="grid grid-cols-1 gap-6 mt-8 md:grid-cols-2">
                            ...
                            <div>
                                <label className="block mb-2 text-sm text-gray-600 ">Email address <span className='text-red-500'>*</span></label>
